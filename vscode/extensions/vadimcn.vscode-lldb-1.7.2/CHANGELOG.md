...
## Fixed
- [#731](https://github.com/vadimcn/vscode-lldb/issues/731): Crash on debug session startup.
...
## Fixed
- [#647](https://github.com/vadimcn/vscode-lldb/issues/647): Cannot display Python string containing non-ASCII characters.
- [#718](https://github.com/vadimcn/vscode-lldb/issues/718): Large containers take too long to display.
- [#726](https://github.com/vadimcn/vscode-lldb/issues/726): Cannot display Rust String's and Vec's (due to data layout change in std).
...
- Added UI for [console mode](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#debug-console) switching.
...
- Added [`debug_info`](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#debugger-commands) LLDB command, that makes it easier to determine which modules have debug info available.
...
- Upon completing a request, the [RPC server](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#rpc-server) will now respond with a status message.
...
- Added [RPC server](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#rpc-server) for "external" launching.
...
## Other
- [Version 5.3](https://github.com/mozilla/rr/releases/tag/5.3.0) of Mozilla's [rr](https://rr-project.org/) has been released a few days ago.  It seems to work pretty well with CodeLLDB's [reverse debugging](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#reverse-debugging) support.
...
- The `.../command` [URL handler](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#starting-debug-session-outside-of-vscode) now supports setting debuggee environment variables.
...
- Added URL handler for [starting a debug session from outside of VSCode](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#starting-debug-session-outside-of-vscode).<br>
...
# 0.8.8
- Added [`postRunCommands`](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#launching).
- Bug fixes.
...
# 0.8.5
- Added support for [Cargo projects](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#cargo-support).
...
- Added `expressions` ∈ { `simple`, `python`, `native` } launch configuration property, which selects the default
  [expression evaluator type](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#expressions).
...
# 0.8.0
- Added [Parameterized Launch Configurations](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#parameterized-launch-configurations).
...
# 0.7.4
- It is now possible to set [default values for launch configurations](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#workspace-configuration) per-workspace.
...
# 0.3.3
- [Custom launch requests](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#custom-launch).
...
# 0.3.2
- Added pickProcess and pickMyProcess commands to be used with the **pid** parameter when [attaching](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/README.md#attaching).
...
# 0.3.0
- [Variable visualizers for Rust](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#rust-language-support).
- New [expression evaluator](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#expressions).
- Bug fixes.
...
# 0.2.0
- Added [disassembly view](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#disassembly-view).
- Added [variable formatting](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#formatting).

# 0.1.3
- Added support for setting variable values (primitive types only).
- Added [regex breakpoints](https://github.com/vadimcn/vscode-lldb/blob/v1.7.2/MANUAL.md#regex-breakpoints).
